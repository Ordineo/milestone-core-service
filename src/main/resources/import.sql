...
insert into Milestone(id, username, createdate, duedate, enddate, moreinformation) values (1, 'gide', '2016-02-01', '2016-12-31', '2016-03-01', 'time to upgrade from java 6 to java 8 certificate.');
